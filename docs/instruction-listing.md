...
[reg(r,?(rd)),imm(?(imm))]
---------------------------------------------------------------------------------------------------------------
<-(bit($$(cc),#(::(cc,carry_flag_bit))),bit(?(rd),\(#(reg_size_bits)- ?(imm),4)));<-(?(rd),?(rd)<< \(?(imm),4))
```
...
[reg(r,?(rd)),imm(?(imm))]
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
?(sign):=bit(?(rd),\(#(reg_size_bits)- #(1),4));?(sign_extension):=sxt(?(sign)- #(1))<< \(#(reg_size_bits)- ?(imm),4);<-(bit($$(cc),#(::(cc,carry_flag_bit))),bit(?(rd),\(?(imm)- #(1),4)));<-(?(rd),or(?(rd)>> \(?(imm),4),?(sign_extension)))
```
...
[reg(r,?(rs)),imm(?(imm))]
------------------------------------------------------------------------------
b_push{bit:bit(mem(?(rs)),\(?(imm),3)),stack_in: $$(ts),stack_out: ->($$(ts))}
```
...
[reg(r,?(rd)),reg(s,?(rs))]
------------------------------------------------------------------------------------------
adder{carryout: ->(bit($$(cc),#(::(cc,carry_flag_bit)))),sum: ->(?(rd)),x: ?(rd),y: ?(rs)}
```
...
[reg(r,?(rd)),reg(s,?(rs))]
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
adder{carryin:bit($$(cc),#(::(cc,carry_flag_bit))),carryout: ?(cout),signin: ?(sin),sum: ->(?(rd)),x: ?(rd),y: ?(rs)};<-(bit($$(cc),#(::(cc,carry_flag_bit))),?(cout));<-(bit($$(cc),#(::(cc,overflow_flag_bit))),?(sin)xor?(cout))
```
...
[reg(r,?(rd)),reg(s,?(rs))]
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
todo((<-(?(rd),?(rd)- ?(rs)- \(bit($$(cc),#(::(cc,carry_flag_bit))),16));<-(bit($$(cc),#(::(cc,carry_flag_bit))),attr(cpu/alu/carryout));<-(bit($$(cc),#(::(cc,overflow_flag_bit))),attr(cpu/alu/overflow))))
```
...
[reg(r,?(r1)),reg(s,?(r2))]
----------------------------------------------------
todo(b_push($$(ts),compare(?(r1),<(\(s,16)),?(r2))))
```
...
[reg(r,?(r1)),reg(s,?(r2))]
----------------------------------------------------
todo(b_push($$(ts),compare(?(r1),<(\(u,16)),?(r2))))
```
...
[]
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
todo(if(bit($$(cc),#(jmp_tgt_validation_en_flag_bit)),if(bit($$(cc),#(jmp_tgt_validation_req_flag_bit)),<-(bit($$(cc),#(jmp_tgt_validation_req_flag_bit)),#(0)),exception('ILLINSTR'))))
```
